...
namespace MedReminder.Pages
{
    ...
    public partial class ResidentMedicationsPage : AuthPage
    {
        ...
        // ✅ Parameterless ctor (Shell-safe) + resolve DI inside
        ...
        private async void OnDeleteClicked(object sender, EventArgs e)
        {
            ...
            var all = await _medicationService.LoadAsync();
            var remaining = all.Where(m => m.Id != med.Id).ToList();
            await _medicationService.SaveAsync(remaining);
        ...
        {
            await Shell.Current.GoToAsync($"editResident?id={ResidentId}");
        }
